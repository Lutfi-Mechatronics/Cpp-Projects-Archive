...
void registration()
{
	...
	while (!customers.eof())
	{
		customers >> i >> name >> password >> "...";                    // "..." denotes variables to be read.
	}
	customers.close();
	...
	cout << "Enter Name (spaces not allowed : "; cin >> name;
	cout << "Password : "; cin >> password;


	customers << i << name << password<<"...";                                 // "..." denotes variables to be input.
	cout << "\nRegistered. ";
	customers.close();
	...
	while (true)
	{
		...
		while (true)
		{
			...
			else if (GetAsyncKeyState(VK_CONTROL) != 0)
			{
				...
				{
					updatesales();	   // updatesales() is portal to choose what product is to be added. viewsales() is viewing sales statistics.
...
// CustomerPurchaces rerun choice for case 2 in void staffAccess()
...
void updatesalesman()
{
	...
	while (!boss.eof() && true)
	{
		...
		if (BossPassword == BossPasswordInput && Boss == BossInput)
		{
			...
			system("cls");
			string Menu[4] = { "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n                  Update Phone Types",
				"                  Update Phone Carrier Types", "                  Update Plans", "                  Logout" };
			...
			while (true)
			{
				...
				while (true)
				{
					...
					else if (GetAsyncKeyState(VK_CONTROL) != 0)
					{
						...
						{
						case 0:
						{updatephonetype(); break; }                    // To access customers' and product details
						case 1:
						{updatecarriertype(); break; }                   // Recruit and firing new staffs
						case 2:
						{updatephoneplans(); break; }
						case 3:
						{staffAccess(); break; }
						}
						a = 4;
